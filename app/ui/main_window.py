...
class VisionApp(ctk.CTk):
    ...
    def _build_sidebar(self):
        ...
        self.scale_selector.pack(pady=(0, 4), padx=20, fill='x')
        ctk.CTkButton(self.sidebar, text=' EXPLORADOR DE MODELOS', command=lambda: ModelExplorerWindow(self, self.detector), height=28, fg_color='#1e293b', border_width=1, border_color='#334155', font=ctk.CTkFont(size=10, weight='bold'), corner_radius=0).pack(pady=(0, 8), padx=20, fill='x')
